  ...
  return (
    <div className="Dashboard">
      ...
      <div className="Wrapper">
        ...
        <main className="Main">
          <div className="Cards">
            <Link to="/SurveillanceBureau/dashboard/identify-criminal" className="Link">
            ...
            <Link to="/SurveillanceBureau/dashboard/register-criminal" className="Link">
            ...
            <Link to="/SurveillanceBureau/dashboard/update-criminal" className="Link">
            ...
            <Link to="/SurveillanceBureau/dashboard/view-history" className="Link">
