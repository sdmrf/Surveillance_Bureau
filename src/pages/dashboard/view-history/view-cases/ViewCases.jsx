...
const ViewCases = ({ criminal, cases, setIsCases }) => {
  if (!cases) {
  ...
  return (
    <div>
      <div className="ViewCases">
        ...
        >
          <ArrowBackIcon style={{ color: "lightgray", fontSize: "30px" }} />
        </button>
          ...
          <div className="card-main">
            <div className="card-section is-active" id="about">
              <div className="card-content enter">
                ...
                <p className="card-desc">
                  <span>Crime Location :</span> {cases[1].crimeLocation}
                </p>
                <p className="card-desc">
                  <span>Description Of Incident :</span> {cases[1].description}
                </p>
              </div>
            </div>
            <div className="card-section " id="experience">
              <div className="card-content enter">
                ...
                <p className="card-desc">
                  <span>Station Address :</span> {cases[2].stationAddress}
                </p>
                <p className="card-desc">
            ...
            <div className="card-section " id="contact">
              <div className="card-content enter">
                ...
                <p className="card-desc">
                  <span>Date Of Hearing :</span> {cases[3].doh}
                </p>
                <p className="card-desc">
                  <span>Court Judgement :</span> {cases[3].judgement}
                </p>
              </div>
            </div>
