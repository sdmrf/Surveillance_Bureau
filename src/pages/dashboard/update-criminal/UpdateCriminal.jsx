  ...
  return (
    <div className="UpdateCriminal">
      <div className="Navbar">
        <div className="Back">
          <Link to="/SurveillanceBureau/dashboard" className="BackArrow"><ArrowBackIcon className="BackArrow" /></Link>
        </div>
        <div className="Update">
          <Link to="/SurveillanceBureau/dashboard/add-new-cases/AddNewCases" style={{ textDecoration: 'none' }}>
            ...
            <div className="UpdateCases">
              ...
              <div className="Content">
                <div className="Case">
                  ...
                  <Link to="/SurveillanceBureau/dashboard/view-history/view-cases" className='Icon'><AddCircleOutlineSharpIcon className='Icon' /></Link>
                </div>
                <div className="Case">
                  <h1 className='CaseID'>#34f211i68d</h1>
